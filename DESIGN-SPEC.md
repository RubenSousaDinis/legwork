...
| `VerifiedChip` | the worker's verification state | full banner "Verified human ✓ · World ID · a live person, camera-checked" at selfie ("one account per person" at orb) + the credential chip, or compact pill "Verified human ✓ · World ID"; **always above the fold on the phone**; naming the credential is part of it |
